...
high_fare_trip = 1 if fare_amount >= 20
high_fare_trip = 0 otherwise

The threshold was selected after analyzing the January 2024 NYC TLC dataset.
...
Trips with fare_amount >= $20 represent approximately the highest-value 25% of trips, making this a practical classification problem for both real-time and batch inference.
